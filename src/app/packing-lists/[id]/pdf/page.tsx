...
function getStampUrlByOrigin(origin?: string | null) {
  const o = String(origin || "").toUpperCase().trim();
  if (o.startsWith("CN") || o.includes("CHINA") || o.includes("QINGDAO")) {
    return "/images/stamp_cn.png";
  }
  return "/images/jm_stamp_vn.jpg";
}
...
export default function PackingListPdfPage() {
  ...
  const resolvedStampUrl = (header?.stamp_url ?? "").toString() || getStampUrlByOrigin(header?.shipping_origin_code);
      ...
      <div className="signWrap">
        ...
        {resolvedStampUrl ? (
          <img
            ...
            style={{ maxWidth: 220, maxHeight: 180, width: "auto", height: "auto", objectFit: "contain" }}
          />
        ) : null}
