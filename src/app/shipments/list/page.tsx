                ...
                {items.length === 0 ? (
                  ...
                  items.map((r) => (
                    <tr key={r.id} className=\"border-b hover:bg-muted/30\">
                      ...
                      <td className=\"px-3 py-2 whitespace-nowrap\">{safe(r.invoice_no) || \"-\"}</td>
                      <td className=\"px-3 py-2 whitespace-nowrap\">{safe(r.packing_list_no) || \"-\"}</td>
                      ...
                      <td className=\"px-3 py-2 text-right whitespace-nowrap\">
                        <div className=\"flex justify-end gap-2\">
                          ...
                          <Button
                            ...
                            disabled={creatingInvoiceId === r.id}
                          >
                            {creatingInvoiceId === r.id ? \"Creating...\" : \"Create Invoice\"}
                          </Button>
